...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_1_cont_1, 240, 280);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_cont_1, lv_color_hex(0x47dc3f), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_meter_set_scale_range(ui->screen_1_meter_1, ui->screen_1_meter_1_scale_0, 0, 40, 300, 90);
    ...
    lv_obj_set_pos(ui->screen_1_meter_1, 33, 50);
    lv_obj_set_size(ui->screen_1_meter_1, 173, 173);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_1, &lv_font_montserratMedium_32, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_label_1, lv_color_hex(0xfa6606), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 70, 233);
    lv_obj_set_size(ui->screen_1_btn_1, 101, 40);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_btn_1, lv_color_hex(0xfa062c), LV_PART_MAIN|LV_STATE_DEFAULT);
