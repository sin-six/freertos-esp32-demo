...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_2_cont_1, lv_color_hex(0x47dc3f), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_2_meter_1, 33, 50);
    lv_obj_set_size(ui->screen_2_meter_1, 173, 173);
    ...
    lv_label_set_text(ui->screen_2_label_1, "humidity");
    lv_label_set_long_mode(ui->screen_2_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_2_label_1, 0, 0);
    lv_obj_set_size(ui->screen_2_label_1, 239, 40);
    ...
    lv_obj_set_style_text_font(ui->screen_2_label_1, &lv_font_montserratMedium_32, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_2_label_1, lv_color_hex(0xfa6606), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_2_btn_1, 70, 233);
    lv_obj_set_size(ui->screen_2_btn_1, 101, 40);
    ...
    lv_obj_set_style_bg_color(ui->screen_2_btn_1, lv_color_hex(0xfa062c), LV_PART_MAIN|LV_STATE_DEFAULT);
